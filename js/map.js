...
class Map {
    ...
    toogleLocationSelector() {
        if (this.selectShops) {
            this.selectShops = false;
            this.removeMarkers();
            $("#shipment_direction").html('\
                <label for="direction"></label><br>\
                <input type="text" name="direction" id="direction" disabled><br>\
                <button id="toogle_location" onclick="map.toogleLocationSelector()" >Recoger en tienda</button>\
            ');
            ...
            $("#shipment_direction").html('\
                <label for="direction"></label><br>\
                <input type="text" name="direction" id="direction" disabled><br>\
                <button id="toogle_location" onclick="map.toogleLocationSelector()" >Buscar dirección</button>\
            ');
        }
    }
